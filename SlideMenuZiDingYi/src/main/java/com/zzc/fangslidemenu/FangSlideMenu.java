...
//        frameLayout1= (FrameLayout) LayoutInflater.from(context).inflate(R.layout.c,null);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        frameLayout2.measure(MeasureSpec.makeMeasureSpec((int) (realwidth*0.8f),MeasureSpec.EXACTLY), heightMeasureSpec);
        frameLayout3.measure(MeasureSpec.makeMeasureSpec((int) (realwidth*0.5f),MeasureSpec.EXACTLY), heightMeasureSpec);
