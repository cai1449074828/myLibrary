...
public class FangSlideMenu extends RelativeLayout{
    ...
    public static final float frameLayout2_xiamian_baifenbi=0.5f;//左边被中间所盖住的长度
    public static final float frameLayout3_xiamian_baifenbi= 0.5f-1f/7;//为了使移动frameLayout2与frameLayout3的速度一致bili=3.5
